  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.header}>
        <Text style={styles.title}>JWT Token Verifier</Text>
        <Text style={styles.subtitle}>
          Upload QR code images, scan codes, or paste tokens to verify
        </Text>
      </View>
      ...
      <View style={styles.uploadSection}>
        ...
        <View style={styles.methodsContainer}>
          ...
          >
            ...
            <Text style={styles.methodSubtext}>Paste token</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={styles.inputSection}>
        <Text style={styles.inputLabel}>Or Paste JWT Token:</Text>
        <TextInput
          style={styles.tokenInput}
          value={tokenInput}
          onChangeText={setTokenInput}
          placeholder="Paste JWT token here or upload QR image above..."
          multiline
          numberOfLines={3}
